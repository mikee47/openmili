...
enum MilightVersion { MILIGHT_UNKNOWN, MILIGHT_V1, MILIGHT_V2 };
...
class MiLightRadio {
  ...
  private:
    ...
    uint8_t _packet[MAX_PACKET_LEN], _out_packet[MAX_PACKET_LEN];
    MilightVersion _version;
    bool _waiting = false;
    unsigned _dupes_received;
};
